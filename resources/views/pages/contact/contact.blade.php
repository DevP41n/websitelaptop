                        ...
                        <div class="contact__address-content">
                            <div class="contact__address-flag d-flex align-items-center">
                                <div class="contact-flag mr-15">
                                    <img src="resources/client/img/contact/flag-1.jpg" alt="">
                                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-8 col-sm-10">
                    <div class="contact__form black-bg-3">
                        <form action="#" >
                            ...
                            <div class="contact__form-input">
                                <input style="background-color: white" type="email" placeholder="Email ...">
                            </div>
                            <div class="contact__form-input">
                                <textarea style="background-color: white" placeholder="Nội dung ..."></textarea>
                            </div>
